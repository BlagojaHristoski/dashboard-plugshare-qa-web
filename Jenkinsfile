pipeline {
    ...
    stages {
        stage('Execute') {
            ...
            post {                
                always{
                emailext attachmentsPattern: 'C:/ProgramData/Jenkins/.jenkins/workspace/Login Plugshare/jenkinsresults/mochawesome.xml', body: 'Find attachments', subject: 'test', to: 'blagoja.hristoski@iwconnect.com'
            }
                }
            }
        }
